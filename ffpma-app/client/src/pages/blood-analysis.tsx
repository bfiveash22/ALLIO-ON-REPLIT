  ...
  return (
    <div className="flex-1 space-y-8 p-8 pt-6 relative min-h-screen">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-3xl font-bold tracking-tight animated-gradient-text">True Vision Blood Analysis</h2>
          <p className="text-muted-foreground mt-1">AI-powered morphological detection aligned with the FFPMA 2026 Protocol.</p>
        </div>
      </div>
