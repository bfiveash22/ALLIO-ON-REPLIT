...
function generateFullProtocol() {
  ...
  drawTable(doc,
    ...
    [
      ["1. Foundation & Detox", "Weeks 1-4", "Supplement foundation, detox", "Full supplement protocol, parasite protocols, detox baths, biodentist, HBOT 3x/wk"],
  ...
  drawTable(doc,
    ...
    [
      ["IV Vitamin C (High Dose)", "2x/week", "Wks 1-12", "Pro-oxidant cancer cell destruction"],
      ["IV DMSO", "1x/week", "Wks 1-8", "Mercury detox, crosses BBB"],
      ["IV Hydrogen Peroxide", "1x/week", "Wks 1-8", "Pathogen elimination"],
      ["Ozonated Glycerin IV", "1x/week", "Wks 5-12", "Immune activation"],
...
function generatePeptideSchedule() {
  ...
  drawTable(doc,
    ...
    [
      ["IV Vitamin C (High Dose)", "2x/week", "Wks 1-12", "Pro-oxidant cancer cell destruction"],
      ["IV DMSO", "1x/week", "Wks 1-8", "Mercury detox, crosses BBB"],
      ["IV H2O2", "1x/week", "Wks 1-8", "Pathogen elimination"],
      ["Ozonated Glycerin IV", "1x/week", "Wks 5-12", "Immune activation"],
      ["NAD+ IM", "1x/week", "Ongoing", "Mitochondrial restoration"],
      ["LipoB IM", "1x/week", "Ongoing", "Fat metabolism, liver support"],
    ],
