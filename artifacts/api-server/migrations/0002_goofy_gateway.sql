CREATE TYPE "public"."indexing_status" AS ENUM('pending', 'processing', 'indexed', 'failed');--> statement-breakpoint
...
CREATE TABLE "agent_library_chunks" (
	...
	"chunk_title" varchar,
	"indexing_status" "indexing_status" DEFAULT 'indexed',
...
CREATE TABLE "agent_library_files" (
	...
	"created_at" timestamp DEFAULT now(),
	CONSTRAINT "agent_library_files_drive_file_id_unique" UNIQUE("drive_file_id")
);
--> statement-breakpoint
