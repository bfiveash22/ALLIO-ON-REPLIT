...
--> statement-breakpoint
ALTER TABLE "generated_protocols" ADD COLUMN "doctor_id" varchar(255);--> statement-breakpoint
ALTER TABLE "generated_protocols" ADD COLUMN "pdf_drive_file_id" varchar(255);--> statement-breakpoint
ALTER TABLE "generated_protocols" ADD COLUMN "pdf_drive_web_view_link" varchar(500);--> statement-breakpoint
ALTER TABLE "generated_protocols" ADD COLUMN "reviewed_by" varchar(255);--> statement-breakpoint
ALTER TABLE "generated_protocols" ADD COLUMN "reviewed_at" timestamp;--> statement-breakpoint
ALTER TABLE "generated_protocols" ADD COLUMN "review_notes" text;--> statement-breakpoint
