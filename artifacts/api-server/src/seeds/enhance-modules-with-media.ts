...
const moduleVideoMappings: Record<string, { videoId: string; description: string }> = {
  ...
  'ecs-203-patient-assessment': { videoId: ALLIO_HEALING_PULSE, description: 'ECS Member Assessment Protocol' },
  ...
  'doc-102-patient-intake': { videoId: TRAINING_INTRO_VIDEO, description: 'Member Intake Protocol' },
