  ...
  "freq-108-clinical-protocols": [
    {
      ...
      content: "Comprehensive member assessment is the foundation of effective frequency medicine. The evaluation begins with a detailed health history including conventional diagnoses, environmental exposures, electromagnetic sensitivity, and prior experience with energy medicine. Bioenergetic assessment tools — such as electrodermal screening (EAV/Meridian Stress Assessment), heart rate variability (HRV) analysis, and thermographic imaging — provide objective data about the member's energetic state. Laboratory findings (inflammatory markers, oxidative stress panels, microbiome analysis) complement the energetic assessment. Contraindication screening is essential: members with pacemakers, cochlear implants, active seizure disorders, pregnancy, or photosensitivity conditions require modified or alternative protocols. Documentation should include baseline measurements, device settings, treatment duration, and member-reported outcomes for each session.",
    },
    {
