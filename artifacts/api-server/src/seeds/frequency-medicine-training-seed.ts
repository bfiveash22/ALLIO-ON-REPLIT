...
const frequencyModuleSections: Record<string, Array<{ title: string; content: string }>> = {
  ...
  "freq-105-pemf-therapy": [
    ...
    },
    {
      ...
      content: "PEMF therapy has gained substantial clinical evidence across multiple conditions. Orthopedic applications include non-union fracture healing (FDA-approved since 1979), osteoarthritis pain reduction, and post-surgical recovery acceleration. Neurological applications include depression support (FDA-cleared rTMS), migraine management, and neuropathic pain. Cardiovascular benefits include improved microcirculation and blood viscosity. Wound healing applications show accelerated epithelialization and collagen synthesis. In integrative oncology, PEMF has demonstrated anti-proliferative effects on certain cancer cell lines while enhancing immune function. Device parameters vary significantly — frequencies range from 1 Hz to thousands of Hz, intensities from micro-Tesla to milli-Tesla, and waveforms include sinusoidal, square, and sawtooth patterns. Selecting appropriate parameters for each condition is critical to wellness outcomes.",
    },
    {
      title: "Device Selection & Wellness Protocols",
      content: "PEMF devices are categorized by intensity: low-intensity (< 100 µT, e.g., BEMER, iMRS), medium-intensity (100 µT – 10 mT), and high-intensity (> 10 mT, e.g., Magnawave, Pulse Centers). Low-intensity devices are generally used for systemic wellness, sleep optimization, and cellular maintenance. High-intensity devices are preferred for acute pain, injuries, and deeper tissue penetration. Session protocols typically specify frequency, intensity, duration, and application site. For general wellness, daily sessions of 8–30 minutes at low intensities are common. For acute conditions, twice-daily sessions at higher intensities may be indicated. Within the FF PMA framework, PEMF is integrated into the Repair and Rebalance phases of the 5R Protocol, supporting tissue regeneration after the Remove and Replace phases have addressed root causes.",
    },
  ],
...
const frequencyModuleKeyPoints: Record<string, string[]> = {
  ...
  "freq-107-scalar-energy": [
    ...
    "Within the FF PMA framework, scalar energy is classified as an experimental adjunct, not a primary modality",
  ],
  "freq-108-clinical-protocols": [
