...
const LBA_QUIZ_DATA_MODULES_8_17: typeof LBA_QUIZ_DATA = [
  {
    ...
    questions: [
      ...
      { id: "q-lba09-09", text: "How does AI assist with wellness decisions?", explanation: "AI suggests relevant protocols from the FFPMA database based on findings, but all suggestions must be reviewed by the practitioner.", answers: [{ text: "Suggests protocols from FFPMA database for practitioner review", isCorrect: true }, { text: "Prescribes medications directly", isCorrect: false }, { text: "Does not assist with wellness", isCorrect: false }, { text: "Overrides practitioner decisions", isCorrect: false }] },
