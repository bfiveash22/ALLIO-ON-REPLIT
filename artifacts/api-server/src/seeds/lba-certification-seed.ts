...
const LBA_QUIZ_DATA_MODULES_8_17: typeof LBA_QUIZ_DATA = [
  {
    ...
    questions: [
      ...
      { id: "q-lba09-09", text: "How does AI assist with wellness decisions?", explanation: "AI suggests relevant protocols from the FFPMA database based on findings, but all suggestions must be reviewed by the practitioner.", answers: [{ text: "Suggests protocols from FFPMA database for practitioner review", isCorrect: true }, { text: "Administers medications directly", isCorrect: false }, { text: "Does not assist with wellness", isCorrect: false }, { text: "Overrides practitioner decisions", isCorrect: false }] },
  ...
  },
  {
    ...
    slug: "lba-wellness-quiz",
    description: "Test your knowledge of wellness protocols and monitoring.",
    questions: [
      { id: "q-lba08-01", text: "What is the optimal retest interval for standard protocols?", explanation: "4 weeks is the optimal retest interval for standard wellness protocols to allow time for interventions to take effect.", answers: [{ text: "4 weeks", isCorrect: true }, { text: "1 day", isCorrect: false }, { text: "6 months", isCorrect: false }, { text: "1 year", isCorrect: false }] },
      ...
      { id: "q-lba08-10", text: "What should happen when new findings appear during monitoring?", explanation: "New findings that weren't present at baseline should be addressed with additional targeted interventions.", answers: [{ text: "Address with additional targeted interventions", isCorrect: true }, { text: "Ignore them", isCorrect: false }, { text: "Stop all protocols", isCorrect: false }, { text: "Repeat baseline only", isCorrect: false }] },
    ],
  },
  {
    moduleId: "lba-mod-11",
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "q-lba12-09", text: "How does terrain assessment guide protocols?", explanation: "Terrain guides protocols: acidic terrain needs alkalinizing, oxidized terrain needs antioxidants, mineral-depleted terrain needs supplementation.", answers: [{ text: "Acidic: alkalinize; Oxidized: antioxidants; Depleted: supplement", isCorrect: true }, { text: "Same protocol for all terrain types", isCorrect: false }, { text: "Terrain has no protocol implications", isCorrect: false }, { text: "Only pharmaceutical approaches", isCorrect: false }] },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "q-lba14-04", text: "What is the wellness goal for blood mycology?", explanation: "The goal is to shift organisms back to their symbiotic phase through terrain correction and isopathic therapy.", answers: [{ text: "Shift organisms back to symbiotic phase", isCorrect: true }, { text: "Kill all organisms", isCorrect: false }, { text: "Promote fungal development", isCorrect: false }, { text: "No protocol is needed", isCorrect: false }] },
  ...
  },
  {
    ...
    questions: [
      { id: "q-lba17-01", text: "How should LBA be presented within the PMA framework?", explanation: "LBA must be presented as an educational assessment tool, not as formal clinical analysis, within the PMA member-to-member context.", answers: [{ text: "As an educational assessment tool, not formal assessment", isCorrect: true }, { text: "As a replacement for all medical testing", isCorrect: false }, { text: "As a clinical assessment procedure", isCorrect: false }, { text: "As a wellness modality", isCorrect: false }] },
      { id: "q-lba17-02", text: "What type of language should be used in LBA reports?", explanation: "Use observation language ('observations suggest' not ('clinical analysis shows')), educational suggestions not Rx orders.", answers: [{ text: "Observation language, not clinical language", isCorrect: true }, { text: "Clinical analysis terminology", isCorrect: false }, { text: "Legal terminology", isCorrect: false }, { text: "Any language is acceptable", isCorrect: false }] },
      ...
      { id: "q-lba17-09", text: "What terminology should replace 'Rx terminology' in PMA context?", explanation: "Within PMA context, use 'educational suggestion' instead of 'Rx' to stay within proper scope of practice.", answers: [{ text: "Educational suggestion", isCorrect: true }, { text: "Medical order", isCorrect: false }, { text: "Wellness protocol", isCorrect: false }, { text: "Rx alternative", isCorrect: false }] },
