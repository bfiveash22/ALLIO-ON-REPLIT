...
const peptideModuleSections: Record<string, Array<{ title: string; content: string }>> = {
  "pp101-fundamentals": [
    ...
    },
    {
      ...
      content: "Within the Forgotten Formula PMA framework, peptide therapy is integrated into the 5R Protocol based on the patient's specific needs. During the Remove phase, immune-modulating peptides (Thymosin Alpha-1, LL-37) support the body's ability to clear infections and reduce pathogen burden. In the Replace phase, metabolic peptides help restore hormonal and enzymatic function. The Reinoculate phase may include gut-healing peptides (BPC-157) to repair intestinal barrier integrity before probiotic reintroduction. The Repair phase leverages healing peptides (BPC-157, TB-500, GHK-Cu) for tissue regeneration. The Rebalance phase uses growth hormone secretagogues and anti-aging peptides to optimize long-term hormonal balance and cellular health. PARACELSUS, the FF PMA's peptide specialist agent, provides personalized guidance on peptide selection and protocol design based on each patient's unique health profile.",
    },
  ],
...
const peptideModuleKeyPoints: Record<string, string[]> = {
  "pp101-fundamentals": [
    ...
    "Within the FF PMA 5R Framework, peptides integrate into every phase based on patient-specific needs",
  ],
  "pp101-injection-techniques": [
