...
export const peptideProtocolTrack = {
  ...
  description: "Advanced clinical training in peptide therapeutics. Master dosing protocols, reconstitution, cycling strategies, and member management. Guided by PARACELSUS agent expertise.",
