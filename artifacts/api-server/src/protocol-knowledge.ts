...
export const imTherapies = [
    ...
    {
      name: "Lipo-B (Lipotropic Complex)",
      category: "Metabolic",
      routeOfAdministration: "IM ONLY",
      description: "Lipo-B is the FF PMA lipotropic injection combining MIC (Methionine, Inositol, Choline) with L-Carnitine, L-Arginine, and B vitamins for enhanced fat metabolism, liver support, and energy optimization. Total concentration: 216mg/mL. IM ONLY — never administer IV.",
      benefits: ["Enhanced fat metabolism", "Liver function support", "Energy boost", "Weight loss support", "Improved cholesterol metabolism", "Fatty acid transport to mitochondria", "Mood enhancement", "Appetite regulation"],
      formulation: "Per mL (216mg total): L-Carnitine 20mg, L-Arginine 20mg, Methionine 25mg, Inositol 50mg, Choline 50mg, Pyridoxine (B6) 25mg, Dexpanthenol (B5) 25mg, Cyanocobalamin (B12) 1mg",
      dosageRange: "1-2 mL IM per injection. 216mg/mL total concentration.",
      reconstitution: "Supplied pre-mixed. No reconstitution required. Multi-dose vials.",
      ...
      precautions: "IM ONLY — do NOT administer IV. Generally safe. Mild injection site reactions possible. Not a replacement for diet and exercise. Avoid in patients with kidney disease (high methionine load).",
      storage: "Refrigerate after opening. Protect from light. Check for particulates before use.",
      notes: "IM ONLY product. Best results when combined with reduced calorie diet and exercise program. Can be combined with other peptides (Semaglutide, Tirzepatide) in comprehensive weight loss protocols. Some patients report improved mental clarity and mood from B-vitamin complex.",
