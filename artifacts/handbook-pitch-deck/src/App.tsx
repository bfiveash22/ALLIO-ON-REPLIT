...
function DownloadButton() {
  ...
  const handleDownload = useCallback(async () => {
    ...
    try {
      ...
      pdf.save("FFPMA-Handbook-Pitch-Deck.pdf");
      setProgress("");
    } catch (err) {
      ...
      <div data-no-nav>
        <button
          ...
          style={{
            ...
            borderRadius: "12px",
            border: "none",
            background: downloading ? "#374151" : "linear-gradient(135deg, #6644BB, #331A80)",
            color: "white",
            fontSize: "14px",
            fontWeight: 600,
            cursor: downloading ? "not-allowed" : "pointer",
            boxShadow: "0 4px 20px rgba(102,68,187,0.4)",
            display: "flex",
            alignItems: "center",
            gap: "8px",
            transition: "all 0.2s",
      ...
      {activeSlideIndex >= 0 && (
        <div style={{
          ...
          <div style={{
            ...
            background: "rgba(102,68,187,0.9)",
            color: "white",
            padding: "10px 28px",
            borderRadius: "8px",
